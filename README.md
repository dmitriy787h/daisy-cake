# BB Cake Clone - Конструктор тортов

Полный клон сайта bb-cake.ru с функциональным конструктором тортов, созданный на Next.js 14 с TypeScript и Tailwind CSS.

## 🎂 Особенности

- **Конструктор тортов** - полный функционал выбора размера, слоев, начинок, декора и упаковки
- **Адаптивный дизайн** - работает на всех устройствах
- **Анимации** - плавные переходы с Framer Motion
- **State Management** - Zustand для управления состоянием конструктора
- **API Routes** - готовые эндпоинты для заказов и расчета стоимости
